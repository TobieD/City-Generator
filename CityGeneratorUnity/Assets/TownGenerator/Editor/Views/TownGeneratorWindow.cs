...
public class TownGeneratorWindow : EditorWindow
{
    ...
    private static void Init()
    {
        ...
        window.maxSize = new Vector2(325, 2000);
    ...
    private void LoadFromXml(string filename)
    {
        ...
        _terrainEditor.Settings.WaterPrefab = AssetDatabase.LoadAssetAtPath<GameObject>(terrain.Element("Lakes").Element("lake").Value);
